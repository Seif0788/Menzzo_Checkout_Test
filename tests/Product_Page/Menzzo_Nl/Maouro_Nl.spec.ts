...
test('Check_Maouro_Nl_product_page', async ({ page }) => {
    ...
    allure.attachment('Console Log', "🚪 Menzzo.nl was opened", 'text/plain');
    ...
    for (const product of productsToProcess) {
        ...
        try {
            ...
            const url = `https://www.menzzo.nl/catalog/product/view/id/${product.entity_id}`;
